...
{"question": r"\text{Solve for } x:\; x^2 - 2x - 4 = 0 \;(\text{correct to 2 decimal places})",
 ...
 "solution_steps":[
 r"a=1,\;b=-2,\;c=-4 \quad (1 Mark)",
 r"x=\frac{-(-2)\pm\sqrt{(-2)^2-4(1)(-4)}}{2(1)} \quad (2 Marks)",
 r"x=\frac{2\pm\sqrt{20}}{2} \quad (1 Mark)",
 r"x=3.24 \;\text{or}\; x=-1.24 \quad (2 Marks)"
 ],
...
{"question": r"\text{Solve for } x:\; 2x^2 + 3x - 5 \le 0",
 ...
 "solution_steps":[
 r"(2x+5)(x-1)\le 0 \quad (2 Marks)",
 r"x=-\frac{5}{2} \;\text{or}\; x=1 \quad (1 Mark)",
 r"-\frac{5}{2}\le x\le 1 \quad (2 Marks)"
 ],
...
{"question": r"\text{Solve simultaneously for } x \text{ and } y:\; x+y=10,\; 2x-y=2",
 ...
 r"x+y=10 \quad \text{...(1)}",
 r"2x-y=2 \quad \text{...(2)}",
 r"\text{Adding (1) and (2)}: 3x=12 \quad (2 Marks)",
 r"x=4 \quad (1 Mark)",
 r"y=10-4=6 \quad (2 Marks)"
 ],
...
{"question": r"\text{Find the 8th term of the geometric sequence } 2,6,18,\dots",
 ...
 "solution_steps":[
 r"a=2,\; r=3 \quad (1 Mark)",
 r"T_n=ar^{n-1} \quad (1 Mark)",
 r"T_8=2(3)^7=4374 \quad (2 Marks)"
 ],
 "final_answer": r"4374",
...
{"question": r"\text{Calculate the sum of the first 15 terms of } 5,9,13,\dots",
 ...
 "solution_steps":[
 r"a=5,\; d=4,\; n=15 \quad (1 Mark)",
 r"S_{15}=\frac{15}{2}[2(5)+(14)(4)] \quad (2 Marks)",
 r"S_{15}=\frac{15}{2}(66)=495 \quad (2 Marks)"
 ],
 "final_answer": r"495",
 "Marks":5,"difficulty":"Medium"},
{"question": r"\text{Determine the sum to infinity of } 8,4,2,1,\dots",
 ...
 "solution_steps":[
 r"a=8,\; r=\frac12 \quad (1 Mark)",
 r"S_\infty=\frac{a}{1-r}=\frac{8}{1-\frac12} \quad (2 Marks)",
 r"S_\infty=16 \quad (1 Mark)"
 ],
 "final_answer": r"16",
 "Marks":4,"difficulty":"Medium"},
],
...
{"question": r"\text{R5000 is invested at 8\% p.a. simple interest for 3 years. Find the accumulated amount.}",
 ...
 "solution_steps":[
 r"A=P(1+ni) \quad (1 Mark)",
 r"A=5000(1+3\times0.08) \quad (2 Marks)",
 r"A=5000(1.24)=6200 \quad (1 Mark)"
 ],
...
{"question": r"\text{A car costing R240 000 depreciates on the reducing-balance method at 12\% p.a. Find its value after 5 years.}",
 ...
 "solution_steps":[
 r"A=P(1-i)^n \quad (1 Mark)",
 r"A=240000(1-0.12)^5 \quad (2 Marks)",
 r"A=240000(0.88)^5\approx126934.61 \quad (2 Marks)"
 ],
...
{"question": r"\text{Thabo saves R800 at the end of every month into an account earning 9\% p.a. compounded monthly for 4 years. Find the future value.}",
 ...
 "solution_steps":[
 r"x=800,\; i=\frac{0.09}{12}=0.0075,\; n=4\times12=48 \quad (2 Marks)",
 r"F=\frac{x[(1+i)^n-1]}{i} \quad (1 Mark)",
 r"F=\frac{800[(1.0075)^{48}-1]}{0.0075}\approx45699.94 \quad (3 Marks)"
 ],
...
{"question": r"\text{Use first principles to find } f'(x) \text{ if } f(x)=x^2",
 ...
 "solution_steps":[
 r"f'(x)=\lim_{h\to0}\frac{(x+h)^2-x^2}{h} \quad (2 Marks)",
 r"=\lim_{h\to0}\frac{2xh+h^2}{h} \quad (2 Marks)",
 r"=\lim_{h\to0}(2x+h)=2x \quad (2 Marks)"
 ],
...
{"question": r"\text{Find the } x\text{-value(s) where } f(x)=x^3-3x \text{ has a turning point.}",
 ...
 "solution_steps":[
 r"f'(x)=3x^2-3 \quad (2 Marks)",
 r"3x^2-3=0 \Rightarrow x^2=1 \quad (2 Marks)",
 r"x=1 \;\text{or}\; x=-1 \quad (2 Marks)"
 ],
...
{"question": r"\text{Determine the } y\text{-intercept of } f(x)=x^2-4x+3",
 ...
 "solution_steps":[
 r"f(0)=0^2-4(0)+3=3 \quad (2 Marks)"
 ],
 "final_answer": r"(0,3)",
...
{"question": r"\text{Determine the } x\text{-intercepts of } f(x)=x^2-4x+3",
 ...
 "solution_steps":[
 r"(x-1)(x-3)=0 \quad (2 Marks)",
 r"x=1 \;\text{or}\; x=3 \quad (1 Mark)"
 ],
...
{"question": r"\text{Find the equations of the asymptotes of } f(x)=\frac{2}{x-1}+3",
 ...
 "solution_steps":[
 r"\text{Vertical asymptote: } x=1 \quad (2 Marks)",
 r"\text{Horizontal asymptote: } y=3 \quad (2 Marks)"
 ],
...
{"question": r"\text{Determine the coordinates of the turning point of } f(x)=x^2-2x-3",
 ...
 "solution_steps":[
 r"x=-\frac{-2}{2(1)}=1 \quad (2 Marks)",
 r"f(1)=1-2-3=-4 \quad (2 Marks)"
 ],
 "final_answer": r"(1,-4)",
 "Marks":4,"difficulty":"Medium"},
]
...
{"question": r"\text{Determine the midpoint of } A(-2,3) \text{ and } B(6,-1)",
 ...
 "solution_steps":[
 r"M=\left(\frac{-2+6}{2},\frac{3+(-1)}{2}\right) \quad (2 Marks)",
 r"M=(2,1) \quad (1 Mark)"
 ],
 "final_answer": r"(2,1)",
 "Marks":3,"difficulty":"Easy"},
{"question": r"\text{Find the gradient of the line through } A(1,1) \text{ and } B(5,9)",
 ...
 "solution_steps":[
 r"m=\frac{9-1}{5-1}=\frac{8}{4}=2 \quad (3 Marks)"
 ],
 "final_answer": r"m=2",
 "Marks":3,"difficulty":"Easy"},
{"question": r"\text{Determine the equation of the line through } A(2,3) \text{ with gradient } 4",
 ...
 "solution_steps":[
 r"y-3=4(x-2) \quad (2 Marks)",
 r"y=4x-5 \quad (2 Marks)"
 ],
...
{"question": r"\text{Determine the equation of the circle with centre } (0,0) \text{ and radius } 5",
 ...
 "solution_steps":[
 r"(x-0)^2+(y-0)^2=5^2 \quad (2 Marks)"
 ],
...
{"question": r"\text{Solve for } x:\; \cos x=-\frac{\sqrt3}{2},\; 0^\circ\le x\le360^\circ",
 ...
 "solution_steps":[
 r"\text{Reference angle}=30^\circ \quad (1 Mark)",
 r"x=180^\circ-30^\circ=150^\circ \quad (1 Mark)",
 r"x=180^\circ+30^\circ=210^\circ \quad (1 Mark)"
 ],
...
{"question": r"\text{In } \triangle ABC,\; a=7,\;b=9,\; C=40^\circ. \text{ Find } c \text{ using the cosine rule.}",
 ...
 "solution_steps":[
 r"c^2=7^2+9^2-2(7)(9)\cos40^\circ \quad (2 Marks)",
 r"c^2\approx 33.48 \quad (1 Mark)",
 r"c\approx5.79 \quad (1 Mark)"
 ],
...
{"question": r"\text{Simplify: } \frac{\sin^2\theta}{1-\cos^2\theta}",
 ...
 "solution_steps":[
 r"1-\cos^2\theta=\sin^2\theta \quad (2 Marks)",
 r"\frac{\sin^2\theta}{\sin^2\theta}=1 \quad (2 Marks)"
 ],
 "final_answer": r"1",
 "Marks":4,"difficulty":"Medium"},
],
...
{"question": r"\text{Find the median of } 3,7,9,12,15",
 ...
 "solution_steps":[
 r"\text{Middle value of 5 sorted numbers is the 3rd value} \quad (2 Marks)"
 ],
 "final_answer": r"9",
 "Marks":2,"difficulty":"Easy"},
{"question": r"\text{Find the standard deviation of } 2,4,6,8 \;(\text{population})",
 ...
 "solution_steps":[
 r"\bar{x}=5 \quad (1 Mark)",
 r"\sum(x-\bar{x})^2=(2-5)^2+(4-5)^2+(6-5)^2+(8-5)^2=20 \quad (2 Marks)",
 r"\sigma=\sqrt{\frac{20}{4}}=\sqrt5\approx2.24 \quad (2 Marks)"
 ],
...
{"question": r"\text{A die is rolled once. Find the probability of getting a number greater than 4.}",
 ...
 "solution_steps":[
 r"\text{Favourable outcomes: } \{5,6\} \quad (1 Mark)",
 r"P(E)=\frac{2}{6}=\frac13 \quad (2 Marks)"
 ],
...
{"question": r"\text{Events A and B are mutually exclusive with } P(A)=0.3 \text{ and } P(B)=0.4. \text{ Find } P(A \text{ or } B).",
 ...
 "solution_steps":[
 r"P(A\text{ or }B)=P(A)+P(B) \quad (2 Marks)",
 r"P(A\text{ or }B)=0.3+0.4=0.7 \quad (1 Mark)"
 ],
 "final_answer": r"0.7",
 "Marks":3,"difficulty":"Medium"},
],
...
{"question": r"\text{O is the centre of a circle. The angle at the centre } AOB=100^\circ. \text{ Find the angle at the circumference } ACB.",
 ...
 "solution_steps":[
 r"ACB=\frac12 \times AOB \quad (2 Marks)",
 r"ACB=\frac12\times100^\circ=50^\circ \quad (1 Mark)"
 ],
...
{"question": r"\text{ABCD is a cyclic quadrilateral with } \hat{A}=110^\circ. \text{ Find } \hat{C}.",
 ...
 "solution_steps":[
 r"\hat{A}+\hat{C}=180^\circ \quad (2 Marks)",
 r"\hat{C}=180^\circ-110^\circ=70^\circ \quad (1 Mark)"
 ],
...
{"question": r"\text{A tangent touches a circle at point } T. \text{ The angle between the tangent and chord } TP \text{ is } 55^\circ. \text{ Find the angle in the alternate segment.}",
 ...
 "solution_steps":[
 r"\text{Angle in alternate segment}=55^\circ \quad (2 Marks)"
 ],
